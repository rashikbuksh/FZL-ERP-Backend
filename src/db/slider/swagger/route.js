		...
		get: {
			...
			responses: {
				200: SE.response_schema(200, {
					...
					puller_type: SE.uuid(),
					puller_type_name: SE.string('puller name'),
					puller_type_short_name: SE.string('puller short name'),
					puller_color: SE.string('red'),
					puller_color_name: SE.string('red'),
					puller_color_short_name: SE.string('red'),
					puller_link: SE.uuid(),
					puller_link_name: SE.string('puller link name'),
					puller_link_short_name: SE.string('puller link short name'),
					slider: SE.uuid(),
					slider_name: SE.string('slider name'),
					slider_short_name: SE.string('slider short name'),
					slider_body_shape: SE.uuid(),
					slider_body_shape_name: SE.string('body shape name'),
					slider_body_shape_short_name: SE.string(
						'body shape short name'
					),
					slider_link: SE.uuid(),
