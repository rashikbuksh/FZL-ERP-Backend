...
export const defStock = SED({
	...
	properties: {
		...
		sa_prod_weight: SE.number(0.0),
		coloring_stock: SE.number(0.0),
		coloring_stock_weight: SE.number(0.0),
		coloring_prod: SE.number(0.0),
		coloring_prod_weight: SE.number(0.0),
		finishing_stock: SE.number(0.0),
		finishing_stock_weight: SE.number(0.0),
		trx_to_finishing: SE.number(0.0),
		trx_to_finishing_weight: SE.number(0.0),
