	...
	const query = sql`
		SELECT 
			...
			CONCAT(
					...
					vodf.end_type_name,
					CASE WHEN (vodf.hand_name IS NOT NULL OR vodf.hand_name != '---' OR lower(vodf.end_type_name) != 'close end') THEN ' - ' ELSE '' END,
					CASE WHEN lower(vodf.end_type_name) != 'close end' THEN vodf.hand_name ELSE '' END,
