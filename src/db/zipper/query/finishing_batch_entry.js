...
export async function selectFinishingBatchEntryBySection(req, res, next) {
	...
	const query = sql`
		SELECT
			...
			zfb.teeth_molding_prod::float8 as teeth_molding_prod,
			zfb.teeth_coloring_stock::float8 as teeth_coloring_stock,
			zfb.finishing_stock::float8 as finishing_stock,
			zfb.finishing_prod::float8 as finishing_prod,
			zfb.warehouse::float8 as warehouse,
