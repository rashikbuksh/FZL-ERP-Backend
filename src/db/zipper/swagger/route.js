...
export const pathZipperOrderInfo = {
	...
	'/v2/zipper/order/details': {
		get: {
			...
			parameters: [
				...
				SE.parameter_query('page', 'page', SE.number(1)),
	...
	'/zipper/order-info/send-from-ho/update/by/{uuid}': {
		put: {
			tags: ['zipper.order_info'],
	...
	'/zipper/order-info/receive-from-factory/update/by/{uuid}': {
		put: {
			tags: ['zipper.order_info'],
	...
	'/zipper/order-info/production-pause/update/by/{uuid}': {
		put: {
			tags: ['zipper.order_info'],
	...
	'/zipper/order-info/swatch-attachment/update/by/{uuid}': {
		put: {
			tags: ['zipper.order_info'],
			...
			parameters: [SE.parameter_params('order info to update', 'uuid')],
			requestBody: SE.requestBody({
				swatch_attachment: SE.string('swatch attachment'),
			}),
			responses: {
				200: SE.response_schema_ref(200, 'zipper/order_info'),
				400: SE.response(400),
	...
	'/zipper/order-info-others': {
		get: {
			tags: ['zipper.order_info'],
			summary: 'Get all order info other details',
			description: '',
			// operationId: "updatePet",
			consumes: ['application/json'],
			produces: ['application/json'],
	...
	'/zipper/order-info/is-cancelled/update/by/{uuid}': {
		put: {
			...
			parameters: [SE.parameter_params('order info to update', 'uuid')],
			requestBody: SE.requestBody({
				is_cancelled: SE.boolean(true),
				is_cancelled_time: SE.date_time(),
				is_cancelled_by: SE.uuid(),
			}),
			responses: {
				200: SE.response_schema_ref(200, 'zipper/order_info'),
				400: SE.response(400),
...
export const pathZipperOrderEntry = {
	...
	'/zipper/bulk-approval': {
		get: {
			tags: ['zipper.order_entry'],
			summary: 'Get all Order Entry for Bulk Approval',
			parameters: [
				SE.parameter_query('type', 'type', [
					'pending',
					'completed',
	...
	'/zipper/swatch-approval-received-bulk-update/{order_number}': {
		put: {
			tags: ['zipper.order_entry'],
			summary: 'Update an existing order entry by uuid',
			description: '',
...
export const pathZipperSfg = {
	...
	'/zipper/sfg-swatch-bulk-update/{order_number}': {
		put: {
			tags: ['zipper.sfg'],
			summary: 'Bulk Update SFG Swatch by Order Number',
			description: '',
			consumes: ['application/json'],
			produces: ['application/json'],
			parameters: [
