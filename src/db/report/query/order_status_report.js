	...
	try {
		...
		const query = sql`
            ...
            SELECT
                ...
                CASE WHEN sfg.recipe_uuid IS NOT NULL THEN oe.swatch_approval_received_date END as swatch_approval_received_date,
                oe.swatch_approval_date as swatch_approval_date,
