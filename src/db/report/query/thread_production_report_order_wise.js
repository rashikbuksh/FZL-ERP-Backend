	...
	try {
		...
		const query = sql`
            SELECT
                ...
                (SUM(coalesce(order_entry.quantity::float8, 0)) - SUM(coalesce(order_entry_batch_entry_coning.total_coning_production_quantity::float8, 0)))::float8 as balance_quantity,
