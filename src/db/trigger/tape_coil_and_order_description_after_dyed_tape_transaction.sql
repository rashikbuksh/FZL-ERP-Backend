...
CREATE TRIGGER tape_coil_and_order_description_after_dyed_tape_transaction_update
...
CREATE TRIGGER tape_coil_and_order_description_after_dyed_tape_transaction_delete
