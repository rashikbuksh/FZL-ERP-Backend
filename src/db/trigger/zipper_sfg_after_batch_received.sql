...
CREATE OR REPLACE FUNCTION zipper_sfg_after_dyeing_batch_received_update() RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW
EXECUTE FUNCTION zipper_sfg_after_dyeing_batch_received_update();
