...
BEGIN
    ...
    SET
       ...
       trx_quantity_in_coil = trx_quantity_in_coil + CASE WHEN NEW.to_section = 'coil' THEN NEW.trx_quantity ELSE 0 END,
        quantity = quantity - CASE WHEN NEW.to_section = 'dying' THEN NEW.trx_quantity ELSE 0 END,
        quantity_in_coil = quantity_in_coil - CASE WHEN NEW.to_section = 'coil' THEN NEW.trx_quantity ELSE 0 END
...
BEGIN
    ...
    SET
       ...
       trx_quantity_in_coil = trx_quantity_in_coil - CASE WHEN OLD.to_section = 'coil' THEN OLD.trx_quantity ELSE 0 END,
        quantity = quantity + CASE WHEN OLD.to_section = 'dying' THEN OLD.trx_quantity ELSE 0 END,
        quantity_in_coil = quantity_in_coil + CASE WHEN OLD.to_section = 'coil' THEN OLD.trx_quantity ELSE 0 END
...
BEGIN
    ...
    SET
       ...
       trx_quantity_in_coil = trx_quantity_in_coil + CASE WHEN NEW.to_section = 'coil' THEN NEW.trx_quantity ELSE 0 END - CASE WHEN OLD.to_section = 'coil' THEN OLD.trx_quantity ELSE 0 END,
        quantity = quantity - CASE WHEN NEW.to_section = 'dying' THEN NEW.trx_quantity ELSE 0 END + CASE WHEN OLD.to_section = 'dying' THEN OLD.trx_quantity ELSE 0 END,
        quantity_in_coil = quantity_in_coil - CASE WHEN NEW.to_section = 'coil' THEN NEW.trx_quantity ELSE 0 END + CASE WHEN OLD.to_section = 'coil' THEN OLD.trx_quantity ELSE 0 END
    WHERE uuid = NEW.tape_coil_uuid;
