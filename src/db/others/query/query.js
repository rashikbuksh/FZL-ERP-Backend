...
export async function selectOrderInfoToGetOrderDescription(req, res, next) {
	...
	const query = sql`
		SELECT 
            ...
            vodf.slider_finishing_stock,
            vodf.marketing_uuid,
            vodf.marketing_name,
            vodf.marketing_phone,
            vodf.buyer_uuid,
            vodf.buyer_name,
            ...
            vodf.marketing_priority,
            vodf.factory_priority,
            ...
            vodf.is_multi_color,
            vodf.is_waterproof,
            vodf.is_marketing_checked,
            vodf.marketing_checked_at,
